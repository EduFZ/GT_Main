...
<body>
    ...
    <header>
        <div class="cabecalho">
            ...
            <ul class="nav">
                <li class="linav"><a class="navtxt" href="#">Home</a></li>
                <li class="linav"><a class="navtxt" href="#">Hospedagens</a></li>
                <li class="linav"><a class="navtxt" href="#">Alugar</a></li>
                <li class="linav"><a class="navtxt" href="#">Cultura</a></li>
                <li class="linav"><a class="navtxt" href="#">Entretenimento</a></li>
    ...
    <h2 class="uxtitle ux">Conheça os Entretenimentos</h2>
